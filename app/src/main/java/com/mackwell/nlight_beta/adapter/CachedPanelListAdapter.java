...
public class CachedPanelListAdapter extends BaseAdapter {
    ...
    public CachedPanelListAdapter(Context context, List<Map<String, String>> dataList){
        mContext = context;
        mDataList = dataList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(rowView==null){
            ...
            viewHolder.ip = (CheckBox) rowView.findViewById(R.id.cached_panel_list_ip_checkBox);
